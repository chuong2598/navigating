...
class InstructionTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return ViewController.chosenRoute!.steps.filter{$0.instructions != ""}.count
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = ViewController.chosenRoute!.steps.filter{$0.instructions != ""}[indexPath.row].instructions
        // Configure the cell...
